...
export default function CategoryPage({ articles, categories, totalArticles, currentPage, currentCategory, settings }) {
  ...
  return (
    <Layout settings={settings}>
      <Head>
        <title>{categoryTitle} | Karir dan Karya Mahasiswa BEM KM UNY</title>
        <meta name="description" content={`Articles in the ${categoryTitle} category from Karir dan Karya Mahasiswa BEM KM UNY.`} />
      </Head>
        ...
        <section className="pt-32 pb-16 section-gradient-1">
          <div className="main-container">
            <div className="text-center mb-16">
              ...
              >
                <FontAwesomeIcon icon={faChevronLeft} className="mr-2" /> Back to All Articles
              </Link>
            ...
            <div className="flex justify-center mt-12">
              <div className="inline-flex items-center">
                <Link 
                  href={`/articles/category/${currentCategory}?page=${Math.max(1, currentPage - 1)}`}
                ...
                {[...Array(totalPages)].map((_, i) => (
                  <Link 
                    key={i}
                    href={`/articles/category/${currentCategory}?page=${i + 1}`}
                ...
                <Link 
                  href={`/articles/category/${currentCategory}?page=${Math.min(totalPages, currentPage + 1)}`}
